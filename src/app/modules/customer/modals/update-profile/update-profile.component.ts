...
export class UpdateProfileComponent implements OnInit {
  ...
  ngOnInit(): void {
    ...
    if (this.data) {
      ...
      this.profileForm.patchValue({
        ...
        customerType: this.data.customer_type_name,
  ...
  getCurrencies() {
    this.customerService.getCurrencies().subscribe((res: any) => {
      this.currencyList = res.data;
    });
  }

  getCustomerTypes() {
    this.customerService.getCustomerTypes().subscribe((res: any) => {
  ...
  onSubmit() {
    ...
    if (this.profileForm.valid) {
      ...
      this.customerService.updateCustomerProfile(this.data.id, formData).subscribe((res: any) => {
        if (res.success) {
